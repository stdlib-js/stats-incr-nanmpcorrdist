...
/**
* If provided input values, the accumulator function returns an updated moving sample Pearson product-moment correlation distance. If not provided input values, the accumulator function returns the current moving sample correlation distance.
*
* ## Notes
*
...
* -   If provided `NaN`, the value is ignored and the returned value is the current accumulated value.
*
* @param x - value
* @param y - value
...
*
* @param W - window size
* @param mx - known mean of `x`
* @param my - known mean of `y`
...
*/
declare function incrnanmpcorrdist( W: number, mx: number, my: number ): accumulator;
